...
Route::group(['prefix' => 'recipes'], function()
{
   ...
   Route::get('{id}/publicize',           'Recipes\RecipesController@publicize')           ->name('recipes.publicize');
   Route::get('{id}/privatize',           'Recipes\RecipesController@privatize')           ->name('recipes.privatize');
