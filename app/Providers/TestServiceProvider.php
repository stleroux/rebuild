   ...
   */
   public function boot()
   {
      ...
      view()->composer('admin.tests.blocks.archives', function ($view) {
         $testlinks = DB::table('tests')
            ->select(DB::raw('YEAR(created_at) year, MONTH(created_at) month, MONTHNAME(created_at) month_name, COUNT(*) test_count'))
