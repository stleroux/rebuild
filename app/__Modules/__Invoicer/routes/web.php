...
Route::group([
	...
	Route::get('invoices/status_invoiced/{inv_id}',		'InvoicesController@status_invoiced')		->name('invoices.status_invoiced');
	Route::get('invoices/status_paid/{inv_id}',			'InvoicesController@status_paid')			->name('invoices.status_paid');
	...
	Route::get('/invoiceItems/create/{inv_id}',			'InvoiceItemsController@create')				->name('invoicer.invoiceItems.create');
