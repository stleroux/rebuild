			...
			<div class="row">
				<div class="col">
					{!! Form::open(['route'=>'darts.cricket.players.store']) !!}
						<input type="hidden" name="user_id" value="2" size="3">
						<input type="hidden" name="game_id" value="{{ $game->id }}" size="3">
						{{-- <div class="col"> --}}
							{{-- <div class="row"> --}}
								{{-- <div class="col p-0"> --}}
									<table class="table table-sm table-bordered bg-danger">
										<tr>
											<td>
										...
										<tr>
											<td colspan="3">{{ $team_1_total_points }}</td>
										</tr>
									</table>
								{{-- </div> --}}
							{{-- </div> --}}
