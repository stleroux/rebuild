<div class="card mb-2" id="categories_edit_category">
      <div class="card-header bg-primary">
      <span class="h4">Edit A Category</span>
         ...
         {{-- <div class="col"> --}}
            ...
            <table class="table table-bordered table-sm table-hover">
               ...
               <tbody>
                  <tr>
                     <td>Category Name</td>
                     <td>This will update the category in the system that will appear under the sub categories</td>
                  </tr>
               </tbody>
            </table>
         {{-- </div> --}}
