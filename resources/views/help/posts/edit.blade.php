<div class="card mb-2" id="posts_edit_post">
      <div class="card-header bg-primary">
      <span class="h4">Edit A Post</span>
         ...
         {{-- <div class="col"> --}}
            ...
            <table class="table table-bordered table-sm table-hover">
               ...
               <tbody>
                  <tr>
                     <td>Post Name</td>
                     <td>This will update the post in the system that will appear under the sub posts</td>
                  </tr>
               </tbody>
            </table>
         {{-- </div> --}}
