<div class="card mb-3 p-0 m-0">
   ...
   <div class="list-group">
      ...
      <a href="#"
         class="list-group-item list-group-item-action p-1 {{ Request::is('albums*') ? 'active' : '' }}">
         <i class="text-danger">
      ...
      <a href="{{ route('articles.index') }}"
         class="list-group-item list-group-item-action p-1 {{ Route::is('articles.*') ? 'active' : '' }}">
         <i class="text-danger">
      ...
      <a href="{{ route('blog.index') }}"
         class="list-group-item list-group-item-action p-1 {{ Request::is('blog*') ? 'active' : '' }}">
      ...
      <a href="#"
         class="list-group-item list-group-item-action p-1 {{ Route::is('darts.*') ? 'active' : '' }}">
         <i class="text-danger">
      ...
      @if(checkPerm('invoicer_index'))
         <a href="{{ route('invoicer') }}"
            class="list-group-item list-group-item-action p-1 {{ Route::is('invoicer.*') ? 'active' : '' }}">
      ...
      <a href="{{ route('recipes.index', 'all') }}"
         class="list-group-item list-group-item-action p-1 {{ Route::is('recipes.index','recipes.myRecipes','recipes.myFavorites') ? 'active' : '' }}">
      ...
      <a href="{{ route('projects.index') }}"
         class="list-group-item list-group-item-action p-1 {{ (Route::is('projects.index') || Route::is('projects.show')) ? 'active' : '' }}">
      ...
      @if(checkPerm('projects_index'))
         <a href="{{ route('projects.list') }}"
            class="list-group-item list-group-item-action p-1 {{ Route::is('projects.list') ? 'active' : '' }}">
