         ...
         <div class="row">
            ...
            <div class="col-3">
               <div class="form-group">
                  ...
                  {{ Form::text ('sName', null, array('class' => 'form-control form-control-sm')) }}
                  <div class="pl-1 bg-danger">{{ $errors->first('sName') }}</div>
               </div>
            </div>
            <div class="col-3">
               <div class="form-group">
                  {{ Form::label('sValue', 'Value', ['class'=>'']) }}
                  {{ Form::text ('sValue', null, array('class' => 'form-control form-control-sm', 'placeholder'=>'See Category Help for details.')) }}
               </div>
            </div>
            <div class="w-100"></div>
            <div class="col">
               <div class="form-group">
                  {{ Form::label('sDescription', 'Description', ['class'=>'']) }}
                  {{ Form::text ('sDescription', null, array('class' => 'form-control form-control-sm')) }}
               </div>
            </div>
         </div>
      </div>
