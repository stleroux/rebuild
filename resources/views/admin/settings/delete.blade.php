   ...
   {!! Form::open(['route'=>['admin.settings.destroy', $setting->id], 'method'=>'DELETE']) !!}
      ...
      <div class="card">
         ...
         <div class="card-body bg-light p-2 text-center">
            @include('admin.settings.buttons.back', ['size'=>'', 'btn_label'=>'No - Return To Previous Page'])
            @include('admin.settings.buttons.btn_delete', ['size'=>'', 'btn_label'=>'Yes - Delete Permanently'])
         </div>
