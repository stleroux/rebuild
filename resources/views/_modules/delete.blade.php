...
@section('content')
   ...
   <div class="card">
      <div class="card-header bg-danger text-white text-center"><b>ARE YOU SURE YOU WANT TO DELETE THE MODULE :: {{ $module }}?</b></div>
      <div class="card-body card_body text-center">
         <form
            action="{{ route('modules.deleteModulePost', $module) }}"
            method="POST"
