...
class PermissionsTableSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        \DB::table('permissions')->insert(array (
            ...
            array (
                'id' => 166,
                'name' => 'woodprojects_index',
                'display_name' => 'index',
                'model' => 'woodprojects',
                'type' => 2,
                'description' => 'list woodprojects',
                'created_at' => NULL,
                'updated_at' => NULL,
            ),
            59 => 
            array (
                'id' => 167,
                'name' => 'woodprojects_create',
                'display_name' => 'create',
                'model' => 'woodprojects',
                'type' => 2,
                'description' => 'create woodprojects',
                'created_at' => NULL,
                'updated_at' => NULL,
            ),
            60 => 
            array (
                'id' => 168,
                'name' => 'woodprojects_edit',
                'display_name' => 'edit',
                'model' => 'woodprojects',
                'type' => 2,
                'description' => 'edit woodprojects',
                'created_at' => NULL,
                'updated_at' => NULL,
            ),
            61 => 
            array (
                'id' => 169,
                'name' => 'woodprojects_show',
                'display_name' => 'show',
                'model' => 'woodprojects',
                'type' => 2,
                'description' => 'view woodprojects',
                'created_at' => NULL,
                'updated_at' => NULL,
            ),
            62 => 
            array (
                'id' => 170,
                'name' => 'woodprojects_delete',
                'display_name' => 'delete',
                'model' => 'woodprojects',
                'type' => 2,
                'description' => 'delete woodprojects',
                'created_at' => NULL,
                'updated_at' => NULL,
            ),
        ));
