                  ...
                  @if($posts->count() > 0)
                     <div class="card mb-2 bg-transparent border-0 pt-0 py-0">
                        <div class="card-body px-0 py-0 text-center">
                           ...
                           <a href="{{ route('posts.unpublished') }}" class="{{ Request::is('posts/unpublished') ? "btn-secondary": "btn-primary" }} btn btn-sm">All</a>
                           @foreach($letters as $value)
                              <a href="{{ route('posts.unpublished', $value) }}" class="{{ Request::is('posts/unpublished/'.$value) ? "btn-secondary": "btn-primary" }} btn btn-sm">{{ strtoupper($value) }}</a>
                           @endforeach
                           </div>
                        </div>
                     </div>
