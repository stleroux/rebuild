...
##################################################################################################################
	public function archive($year, $month)
	{
		...
		return view('posts::blog.archive', compact('archives','postlinks'))->withYear($year)->withMonth($month);
	}
...
##################################################################################################################
	public function getIndex()
	{
      ...
      // if(!checkPerm('post_blog_index')) { abort(401, 'Unauthorized Access'); }
		...
		return view ('posts::blog.index', compact('posts','postlinks'));
	}
...
##################################################################################################################
	public function print($id)
	{
		...
		return view('posts::blog.print', compact('post'));
	}
...
##################################################################################################################
	 public function search(Request $request)
	 {
		...
		$postlinks = DB::table('posts')
		  ...
		  return view('posts::blog.search', compact('posts','postlinks'));
	 }
...
##################################################################################################################
	public function getSingle($slug)
	{
		...
		return view('posts::blog.single', compact('post','postlinks','next','previous'));
	}
