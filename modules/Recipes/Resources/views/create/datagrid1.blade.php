<div class="card mb-3">
   <div class="card-header">
      ...
      <span class="float-right">
         ...
         <a href="{{ Route( Session::get('backURL') ) }}" class="btn btn-sm btn-primary px-1 py-0">
      ...
      <div class="row">
         ...
         <div class="col-sm-12">
            <div class="form-group {{ $errors->has('methodology') ? 'has-error' : '' }}">
               {{ Form::label('methodology', 'Methodology', ['class'=>'required']) }} <small>(One instruction per line)</small>
